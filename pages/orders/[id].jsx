      ...
      <div className={styles.left}>
        <div className={styles.row}>
          <table className={styles.table}>
            ...
            <tr className={styles.tr}>
              <td>
                <span className={styles.id}>123123123123123</span>
              </td>
              <td>
                <span className={styles.name}>John Doe</span>
              </td>
              <td>
                <span className={styles.address}>Elton St, 122-22 LA</span>
              </td>
              <td>
        ...
        <div className={styles.row}>
            <div className={statusClass(0)}>
                ...
                <div className={styles.checkedIcon}><Image className={styles.chekedIcon} src="/img/checked.png" alt="" width={20} height={20}/></div>
            </div>
